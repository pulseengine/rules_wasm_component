...
**This tells Bazel how to build your Go code into a WebAssembly component.** The [`go_wasm_component`](/reference/rules/#go_wasm_component) rule automatically handles TinyGo compilation, WIT binding generation, and component packaging:
...
<div class="demo-buttons">
  <a
    href="https://stackblitz.com/github/pulseengine/rules_wasm_component/tree/main/examples/go_component"
    class="demo-button"
  >
    Try Go Example
  </a>
