...
> **📋 Rule Reference:** For complete details on all C++ rule attributes, see [`cpp_component`](/reference/rules/#cpp_component) and [`cpp_wit_bindgen`](/reference/rules/#cpp_wit_bindgen).
