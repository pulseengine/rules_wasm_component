...
> **📋 Rule Reference:** For complete details on all JavaScript rule attributes, see [`js_component`](/reference/rules/#js_component) and [`jco_transpile`](/reference/rules/#jco_transpile).
