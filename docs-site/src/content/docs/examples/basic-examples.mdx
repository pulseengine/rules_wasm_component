...
description: Simple examples demonstrating fundamental usage patterns of rules_wasm_component
---
...
:::note
This pattern works for all components, including those with external WIT dependencies.
:::
