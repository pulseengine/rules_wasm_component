...
#[cfg(target_arch = "wasm32")]
use traditional_component_bindings::example::symmetric::logger::{log, log_calculation, LogLevel};
...
impl Guest for TraditionalCalculator {
    fn add(a: i32, b: i32) -> i32 {
        ...
        log(LogLevel::Info, &format!("Traditional addition result: {}", result));
    ...
    fn multiply(a: i32, b: i32) -> i32 {
        ...
        log(LogLevel::Info, &format!("Traditional multiplication result: {}", result));
    ...
    fn calculate_stats(numbers: Vec<i32>) -> Stats {
        if numbers.is_empty() {
            log(LogLevel::Warn, "Empty list provided to traditional calculate_stats");
            return Stats {
                sum: 0,
                count: 0,
                average: 0.0,
