...
use gateway::microservices::exports::wasi::http::incoming_handler::{Guest, IncomingRequest, ResponseOutparam};
...
impl Guest for ApiGateway {
    fn handle(request: IncomingRequest, response_out: ResponseOutparam) {
        ...
        let response_body = r#"{"status": "API Gateway Active", "services": ["user", "product", "order"]}"#;
